...
mod post {
    ...
    use shared::{
        ...
        models::{
            ...
            server_database::{MUTATE_MAX_ROWS, RowDelete},
    ...
    pub async fn route(
        ...
        tokio::spawn(async move {
            let affected = match client
                .post_instances_instance_databases_database_explorer_rows_delete(
                    database_instance.uuid,
                    database,
                    &db_agent_api::instances_instance_databases_database_explorer_rows_delete::post::RequestBody {
                        schema: data.schema,
            ...
            activity_logger
                .log(
                    "server:database-instance.database.rows-delete",
                    serde_json::json!({
