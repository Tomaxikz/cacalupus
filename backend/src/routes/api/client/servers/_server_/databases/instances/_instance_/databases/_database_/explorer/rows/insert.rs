...
mod post {
    ...
    use shared::{
        ...
        models::{
            ...
            server_database::{MUTATE_MAX_ROWS, RowInsert},
    ...
    pub async fn route(
        ...
        tokio::spawn(async move {
            let affected = match client
                .post_instances_instance_databases_database_explorer_rows_insert(
                    database_instance.uuid,
                    database,
                    &db_agent_api::instances_instance_databases_database_explorer_rows_insert::post::RequestBody {
                        schema: data.schema,
            ...
            activity_logger
                .log(
                    "server:database-instance.database.rows-insert",
                    serde_json::json!({
