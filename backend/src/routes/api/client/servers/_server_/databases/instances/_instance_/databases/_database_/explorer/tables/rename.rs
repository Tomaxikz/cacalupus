...
mod post {
    ...
    pub async fn route(
        ...
        tokio::spawn(async move {
            match client
                .post_instances_instance_databases_database_explorer_tables_rename(
                    database_instance.uuid,
                    database,
                    &db_agent_api::instances_instance_databases_database_explorer_tables_rename::post::RequestBody {
                        schema: data.schema,
            ...
            activity_logger
                .log(
                    "server:database-instance.database.table-rename",
                    serde_json::json!({
