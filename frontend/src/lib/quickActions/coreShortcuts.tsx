...
import { ModifierKey, ShortcutCategory, ShortcutDefinition } from '@/lib/quickActions/shortcuts.ts';
...
function buildCoreShortcutDefinitions(): ShortcutDefinition[] {
  ...
  return [
    ...
    },
    {
      ...
      defaultBinding: binding('d', ['ctrlOrMeta']),
    },
    {
      id: 'files.search',
      category: fileManager,
    ...
    {
      id: 'files.closeEditorTab',
      category: fileManager,
      description: () => getTranslations().t('pages.account.shortcuts.fileManager.closeEditorTab', {}),
      defaultBinding: binding('w', ['ctrlOrMeta']),
      allowWhenInputFocused: true,
      preventDefault: true,
    },
    {
      id: 'files.nextEditorTab',
      category: fileManager,
      description: () => getTranslations().t('pages.account.shortcuts.fileManager.nextEditorTab', {}),
      defaultBinding: binding('Tab', ['ctrlOrMeta']),
      allowWhenInputFocused: true,
      preventDefault: true,
    },
    {
      id: 'files.previousEditorTab',
      category: fileManager,
      description: () => getTranslations().t('pages.account.shortcuts.fileManager.previousEditorTab', {}),
      defaultBinding: binding('Tab', ['ctrlOrMeta', 'shift']),
      allowWhenInputFocused: true,
      preventDefault: true,
    },
    {
